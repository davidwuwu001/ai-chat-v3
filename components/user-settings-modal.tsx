          ...
          <div className="text-center">
            ...
            <div className="relative inline-block">
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 w-8 h-8 bg-blue-500 hover:bg-blue-600 text-white rounded-full flex items-center justify-center transition-colors shadow-lg"
              >
            ...
            <input
              ...
              className="hidden"
            />
            <p className="text-xs mt-2" style={{ color: 'var(--color-text)', opacity: 0.6 }}>
